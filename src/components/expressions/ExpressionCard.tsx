...
export function ExpressionCard({
  ...
  return (
    <div className="bg-black border border-[#00FF00]/30 rounded-lg p-4 hover:border-[#00FF00]/60 transition-colors">
      <h3 className="text-[#00FF00] text-lg font-bold mb-3 text-center">
        ...
        {showBothDeviceTypes ? (
          <>
            <div className="flex flex-col items-center">
              <p className="text-xs text-gray-400 mb-1">スマートフォン版</p>
              <canvas
            ...
            <div className="flex flex-col items-center">
              <p className="text-xs text-gray-400 mb-1">タブレット版</p>
              <canvas
                ref={tabletCanvasRef}
                className="border border-[#333]"
                style={{ imageRendering: 'pixelated' }}
