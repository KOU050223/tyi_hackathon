 ...
 */
export function blendshapesToMap(blendshapes: FaceBlendshapes): Map<BlendshapeName, number> {
 ...
 */
export function averageBlendshapes(blendshapes: FaceBlendshapes, names: BlendshapeName[]): number {
